...
<html>
  ...
  <body>
        <div id="pageBody">
            ...
            <h1>${message(code: 'place.order.request.reset.order.heading', default: 'Reset order')}</h1>
            ...
            <input type="hidden" id="id" name="id" value="${order.id}"/>
             <select name="newRequestStatus" id="newRequestStatus">
              ...
              <input type="submit" name="submitButton" id="submitButton" class="button" value="${message(code: 'place.order.request.reset.status.button.label', default: 'Reset status')}"/>
            </form>
