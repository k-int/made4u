...
<html>
  <head>
    ...
    <title>${message(code: 'lens.database.lens.special.colour.create.page.head.title', default: 'Lens special colour details - create new')} &lt;&lt; Made4U</title>
  ...
  <body>
        ...
        <div id="pageBody">
            <h1>${message(code: 'lens.database.lens.special.colour.create.title', default: 'Individual lens special colour')}</h1>
            ...
            <h2>${message(code: 'lens.database.lens.special.colour.create.properties.heading', default: 'Lens special colour properties:')}</h2>
            ...
            <g:form method="post" name="colourForm">
              ...
              <div class="extraConfigOptions">
                ...
                <div class="buttonArea">
                  <button type="submit" name="_action_save" class="button" controller="lensSpecialColour"><img src="${createLinkTo(dir, '/images/')}/save.jpg" alt="${message(code: 'save.button.label', default: 'Save changes')}"/> ${message(code: 'save.button.text', default: 'Save')}</button>
