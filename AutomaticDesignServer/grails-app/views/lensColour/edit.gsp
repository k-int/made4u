...
<html>
  <head>
    ...
    <title>${message(code: 'lens.colour.edit.page.head.title', default: 'Lens colour details - edit')} &lt;&lt; Made4U</title>
  ...
  <body>
        ...
        <div id="pageBody">
            <h1>${message(code: 'lens.colour.edit.title', default: 'Individual lens colour')}</h1>
            ...
            <h2>${message(code: 'lens.colour.edit.properties.heading', default: 'Lens colour properties:')}</h2>
            ...
            <g:form method="post" name="colourForm">
              ...
              <div class="propertiesTable">
                <table class="propertiesTable">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="price" value="${formatNumber(number:colourInstance.price, format:"0.0")}" class="required" titl${message(code: 'lens.colour.price.required.message', default: 'A price is required for the colour')}"/>
                    </td>
                  </tr>
              ...
              <div class="extraConfigOptions">
                ...
                <div class="buttonArea">
                  <button type="submit" name="_action_update" class="button" controller="lensColour"><img src="${createLinkTo(dir, '/images/')}/save.jpg" alt="${message(code: 'save.button.label', default: 'Save changes')}"/> ${message(code: 'save.button.text', default: 'Save')}</button>
