...
<html>
  <head>
    ...
    <title>${message(code: 'lens.coating.edit.page.head.title', default: 'Lens coating details - edit')} &lt;&lt; Made4U</title>
  ...
  <body>
        ...
        <div id="pageBody">
            <h1>${message(code: 'lens.coating.edit.title', default: 'Individual lens coating')}</h1>
            ...
            <h2>${message(code: 'lens.coating.edit.properties.heading', default: 'Lens coating properties:')}</h2>
            ...
            <g:form method="post" name="coatingForm">
              ...
              <table class="propertiesTable">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="transparencyIndex" value="${formatNumber(number:coatingInstance.transparencyIndex, format:"0.0")}" title="${message(code: 'lens.coating.colour.transparency.index.required.label', default: 'A transparency index colour component when creating a coating')}" class="required"/>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input type="text" name="saturationTransparencyIndex" value="${formatNumber(number:coatingInstance.saturationTransparencyIndex, format:"0.0")}" title="${message(code: 'lens.coating.colour.saturation.transparency.index.required.label', default: 'A saturation transparency index colour component when creating a coating')}" class="required"/>
                    </td>
                  </tr>
                  <tr>
                ...
                <div class="buttonArea">
                  <button type="submit" name="_action_update" class="button" controller="lensCoating"><img src="${createLinkTo(dir, '/images/')}/save.jpg" alt="${message(code: 'save.button.label', default: 'Save changes')}"/> ${message(code: 'save.button.text', default: 'Save')}</button>
                  <g:link class="button" action="show" id="${coatingInstance.id}"><img src="${createLinkTo(dir, '/')}images/cancel.png" alt="${message(code: 'cancel.button.label', default: 'Cancel')}"/> ${message(code: 'cancel.button.text', default: 'Cancel')}</g:link>
                </div>
              </g:form>
       </div>
