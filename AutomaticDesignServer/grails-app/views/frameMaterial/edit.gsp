...
<html>
  <head>
    ...
    <title>${message(code: 'frame.material.edit.page.head.title', default: 'Frame material details - edit')} &lt;&lt; Made4U</title>
  ...
  <body>
        ...
        <div id="pageBody">
            <h1>${message(code: 'frame.material.edit.page.title', default: 'Individual Frame material')}</h1>
            ...
            <h2>${message(code: 'frame.material.edit.page.properties.heading', default: 'Frame material properties:')}</h2>
            ...
            <g:form method="post" name="materialForm">
              ...
              <div class="buttonArea">
                <button type="submit" name="_action_update" class="button" controller="frameMaterial"><img src="${createLinkTo(dir, '/images/')}/save.jpg" alt="${message(code: 'save.button.label', default: 'Save')}"/> ${message(code: 'save.button.text', default: 'Save')}</button>
