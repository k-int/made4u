...
<html>
  <head>
    ...
    <title>${message(code: 'frame.colour.create.page.head.title', default: 'Frame colour details - create new')} &lt;&lt; Made4U</title>
  ...
  <body>
        ...
        <div id="pageBody">
            <h1>${message(code: 'frame.colour.create.title', default: 'Individual frame colour')}</h1>
            ...
            <h2>${message(code: 'frame.colour.create.properties.heading', default: 'Frame colour properties:')}</h2>
            
            <g:form method="post" name="colourForm" action="save">
              <g:hiddenField name="version" value="${colourInstance.version}"/>
              
              <table class="propertiesTable">
                  <tr>
                    <td class="tableHeading">${message(code: 'frame.colour.name.label', default: 'Name')}: <em class="required">*</em></td>
              ...
              <div class="buttonArea">
                <button type="submit" name="_action_save" class="button" controller="frameBaseColour"><img src="${createLinkTo(dir, '/images/')}/save.jpg" alt="${message(code: 'save.button.label', default: 'Save')}"/> ${message(code: 'save.button.text', default: 'Save')}</button>
