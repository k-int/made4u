...
<html>
  <head>
    ...
    <title>${message(code: 'frame.emotional.variable.edit.page.head.title', default: 'Frame emotional variable details - edit')} &lt;&lt; Made4U</title>
  ...
  <body>
        ...
        <div id="pageBody">
            <h1>${message(code: 'frame.emotional.variable.edit.page.title', default: 'Individual Emotional variable')}</h1>
            ...
            <h2>${message(code: 'frame.emotional.variable.edit.page.properties.heading', default: 'Emotional variable properties:')}</h2>
            ...
            <g:form method="post" name="emotionalForm">
              ...
              <table class="propertiesTable">
                  <tr>
                    ...
                    <td class="value" colspan="2">
                      ${fieldValue(bean: emotionalInstance, field: "id")}
                    </td>
                  </tr>
                  <tr>
              ...
              <div class="buttonArea">
                <button type="submit" name="_action_update" class="button" controller="frameEmotionalVariable"><img src="${createLinkTo(dir, '/images/')}/save.jpg" alt="${message(code: 'save.button.label', default: 'Save')}"/> ${message(code: 'save.button.text', default: 'Save')}</button>
                <g:link class="button" action="show" id="${emotionalInstance.id}"><img src="${createLinkTo(dir, '/')}images/cancel.png" alt="${message(code: 'cancel.button.label', default: 'Cancel')}"/> ${message(code: 'cancel.button.text', default: 'Cancel')}</g:link>
              </div>
