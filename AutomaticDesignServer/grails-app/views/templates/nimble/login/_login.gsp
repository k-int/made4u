    ...
    <div class="login">
      ...
      <div id="local" class="localonlymethod">
        ...
        <g:form action="signin" name="signin">
          ...
          <fieldset>
            <label for="username" class="append-1"><g:message code="nimble.label.username" />
              <input id="username" type="text" name="username" class="title"/>
            </label>

            <label for="password" class="append-1"><g:message code="nimble.label.password" />
              <input id="password" type="password" name="password" class="title"/>
            </label>
          </fieldset>

          <fieldset>
            <label><g:message code="nimble.label.rememberme" />
              <g:checkBox id="rememberme" name="rememberme"/>
            </label>
          </fieldset>
